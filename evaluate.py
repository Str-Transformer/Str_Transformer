...
import models.Str_Transformer as St_Former
...
# 모델 정의
    model = St_Former.Str_Transformer(global_feat=True, feature_transform=True,
...
if __name__ == "__main__":
    ...
    dataset_list = ['oxford_evaluation', 'university_evaluation', 'residential_evaluation', 'business_evaluation']
    cfg.DATASET_FOLDER = FLAGS.dataset_folder
    
    for dataset in tqdm(dataset_list):
        cfg.EVAL_DATABASE_FILE = cfg.DATASET_FOLDER + '/' + dataset + '_database.pickle'
        cfg.EVAL_QUERY_FILE    = cfg.DATASET_FOLDER + '/' + dataset + '_query.pickle'
        
        cfg.LOG_DIR = 'log/'
        cfg.OUTPUT_FILE = cfg.RESULTS_FOLDER + cfg.OUTPUT_FILE_NAME + '_' + dataset +'_evaluate.txt'
        evaluate()
